...
// LAST LEVEL CACHE
#define LLC_SET NUM_CPUS*2048/2
#define LLC_WAY 16
...
#define LLC_LATENCY 20/2  // 4/5 (L1I or L1D) + 10 + 20 = 34/35 cycles
...
class CACHE : public MEMORY {
  public:
    ...
    void upper_invalidate(BLOCK** block, uint32_t set, uint32_t way, uint32_t fill_cpu, uint32_t mshr_index);
    void make_undirty(PACKET *packet);
