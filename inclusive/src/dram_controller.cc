...
int MEMORY_CONTROLLER::check_hit(PACKET *packet)
{
...
void MEMORY_CONTROLLER::handle_fill(){
    
}

void MEMORY_CONTROLLER::make_undirty(PACKET *packet){
    
}


int MEMORY_CONTROLLER::is_dirty(PACKET *packet){
